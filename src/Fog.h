...
public:
    ...
    void setUp() {
        window = initGLFW(1024, 768, "Fog", nullptr, nullptr);
        ...
        GLint out[2];
        LoadTexture(programID,"resource/fog.png","myTextureSampler",out);
        particle=out[1];
        TextureID = out[0];
    ...
    void update() {
        ...
        for(int i=0; i<newparticles; i++){
            ...
            particleSetLife(7.0f); // Czas zycia czasteczki
            particleSetPos((rand()%100)/10.0f,(rand()%30)/10.0f,(rand()%70)/10.0f); //Pozycja emitera
            ...
            //Ustawianie kolorow
            particleSetColor(254,254,254,20);
            //Wielkosc czasteczki
